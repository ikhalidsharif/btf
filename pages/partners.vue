<template>
  <div class="partners-page">
    ...
    <section class="why-section">
      <div class="container">
        <h2 class="section-title center">{{ locale === 'ar' ? 'ليش تشاركنا؟' : 'Why Partner With Us?' }}</h2>
        <div class="why-grid">
          <div v-for="w in reasons" :key="w.titleEn" class="why-card card fade-up">
            <span class="why-icon">{{ w.icon }}</span>
            <h3>{{ locale === 'ar' ? w.titleAr : w.titleEn }}</h3>
            <p>{{ locale === 'ar' ? w.textAr : w.textEn }}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="cta-section">
      <div class="container cta-inner">
        <h2>{{ locale === 'ar' ? 'تبي تكون شريكاً معنا؟' : 'Want to Become a Partner?' }}</h2>
        <p>{{ locale === 'ar'
          ? 'سواء كنت شركة أو جهة حكومية أو فرداً، يسعدنا نسمع منك'
          : "Whether you're a company, a government entity, or an individual, we'd love to hear from you" }}</p>
...
useHead({
  title: locale.value === 'ar' ? 'الشركاء والرعاة | مؤسسة البحرين ترست' : 'Our Partners & Sponsors | Bahrain Trust Foundation',
})

// Logos self-hosted under /public/images/partners/ — kept in sync with the
// homepage partners array manually for now.
// Ordered to match the reference logo grid from the official notes document
// (rows, left to right). A few small/ambiguous crest icons in that image
// couldn't be identified with confidence and are omitted; entries we have
// that weren't in the reference image are appended at the end.
const partners = [
  // Row 1
  ...
  { name: 'Safeya Ali Kanoo', image: '/images/partners/safeya-ali-kanoo-logo.png' },
  // Row 2
  { name: 'BUB', image: '/images/partners/bub-logo.png' },
  { name: 'RUW', image: '/images/partners/ruw-logo.png' },
  ...
  { name: 'RMS', image: '/images/partners/rms-logo-vertical-colour-f3a6686843.png' },
  // Row 3
  { name: 'Suhail Al Gosaibi', image: '/images/partners/suhail-algosaibi-logo-1-3.png' },
  { name: 'Tamkeen', image: '/images/partners/tamkeen.png' },
  { name: 'UNDP', image: '/images/partners/undp-logo-blue-large-transparent.png' },
  { name: 'Ministry of Education', image: '/images/partners/moe-logo.png' },
  { name: 'Monét', image: '/images/partners/mon-t-logotype-black.png' },
  { name: 'RAK Art Foundation', image: '/images/partners/rak-art-foundation4.png' },
  // Row 4
  { name: 'Al Soroor', image: '/images/partners/al-soroor.png' },
  { name: 'Al Ayam', image: '/images/partners/alayam.png' },
  { name: 'ASU', image: '/images/partners/asu.png' },
  { name: 'Ahli United Bank', image: '/images/partners/ahli-united-bank.png' },
  { name: 'RHF', image: '/images/partners/rhf-logo.png' },
  { name: 'UNV', image: '/images/partners/unv-logo-english-positive-rgb.png' },
  { name: 'Ministry of Social Development', image: '/images/partners/mosd-logo.png' },
  { name: 'GPIC', image: '/images/partners/جيبك.png' },
  // Row 5
  { name: 'King Hamad General Hospital', image: '/images/partners/king-hamad-general-hospital-logo.png' },
  { name: 'E.K. Kanoo', image: '/images/partners/ekkanoo.png' },
  { name: 'EWA', image: '/images/partners/ewalogo.png' },
  { name: 'ID Design', image: '/images/partners/iddesign-logo-1-e1587407317390-1.png' },
  { name: 'Jahez', image: '/images/partners/jahez-logo.png' },
  { name: 'BISB', image: '/images/partners/bisb-logo.png' },
  { name: 'BMMI', image: '/images/partners/bmmi-700x380.png' },
  { name: 'Canadian School Bahrain', image: '/images/partners/canadian-school.png' },
  { name: 'Capital Municipality', image: '/images/partners/capital-municipality.png' },

  // Not in the reference image — kept below so nothing is lost
  ...
  { name: 'Bayan School', image: '/images/partners/bayan-school-logo-186x300.png' },
  { name: 'BDF Hospital', image: '/images/partners/bdf-hospital-logo.png' },
  { name: 'BETU', image: '/images/partners/betu-logo.png' },
  { name: 'Capital Governorate', image: '/images/partners/capital-governorate-logo.png' },
  { name: 'Raedat', image: '/images/partners/logo-raedat-1.png' },
  { name: 'Keys School', image: '/images/partners/keys-logo.png' },
  { name: 'National Arts Council', image: '/images/partners/logo-organizations-primary-national-arts-council.png' },
  { name: 'Ministry of Labour', image: '/images/partners/mol-logo.png' },
  { name: 'Muharraq Municipality', image: '/images/partners/muharraq-municipality.png' },
  { name: 'Bahrain Polytechnic', image: '/images/partners/polytechnic-logo.png' },
  { name: 'Sard', image: '/images/partners/sard-logo.png' },
  { name: "St. Christopher's School", image: '/images/partners/stchrislogocropmarks.png' },
...
const reasons = [
  {
    icon: '🎯', titleAr: 'أثر مباشر وواضح', titleEn: 'Direct, Visible Impact',
    textAr: 'مشاريعنا ملموسة — مدارس، فضاءات، برامج تدريبية — تشوف أثر شراكتك بعينك.',
    textEn: 'Our projects are tangible — schools, spaces, training programs — you can see the impact of your partnership firsthand.',
  },
  {
    icon: '🤝', titleAr: 'شفافية بالتعامل', titleEn: 'Transparent Collaboration',
    textAr: 'نتعامل بوضوح ومسؤولية مع كل شريك، ونشارك تحديثات دورية عن المشاريع المدعومة.',
    textEn: 'We work with clarity and accountability with every partner, sharing regular updates on supported projects.',
  },
  {
    icon: '🌍', titleAr: 'أثر محلي وعالمي', titleEn: 'Local & Global Reach',
    textAr: 'مشاريعنا تمتد من أحياء البحرين إلى مجتمعات محتاجة بسبع دول حول العالم.',
    textEn: 'Our projects extend from Bahraini neighborhoods to communities in need across seven countries worldwide.',
  },
]
</script>
...
.why-icon { font-size: 32px; display: block; margin-bottom: 14px; }
